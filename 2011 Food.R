...
summary(hundredmedians$Median)


library('ggplot2')
ggplot(hundredmedians,aes(x=Median,))+
  geom_histogram(binwidth = .3, fill = '#00BFC4')+
  labs(title = "Median Distribution from foodcomparison, n = 10,000",
       x= "Median ng/day PFOA Food",
       y= "Count")
